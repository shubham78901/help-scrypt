...
import { getDefaultSigner, randomPrivateKey, sleep } from './tests/utils/helper'
import { myPublicKey } from './tests/utils/privateKey'
...
async function deploy_Normal() {
    ...
    const Protocol_Name="Chain-protocol"
